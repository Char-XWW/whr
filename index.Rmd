...
## 1.1_Plot: Happiness Score and GDP per Capital
...
## 1.4_Scatter Plot: GDP and Happiness

```{r}
plot_ly(data = data, 
        x=~Economy..GDP.per.Capita., y=~Happiness.Score, color=~Health..Life.Expectancy., type = "scatter",
        text = ~paste("Country:", Country)) %>% 
        layout(title = "Happiness, GDP and Health relationship", 
               xaxis = list(title = "GDP per Capita"),
               yaxis = list(title = "Happiness Score"))
### from this scatter we can know, that those contries with high GDP per Capita, also have higher Happiness Score and higher Heath expectancy. See? Money do matters.
```
